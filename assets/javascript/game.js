$(document).ready(function () {
    ...
    $("#img2").html("<img src=" + "assets/images/pink.jpg" + " value=" + gemTwo + ">");

    var gemThree = Math.floor(Math.random() * 12) + 1;
    console.log("Gem 3: " + gemThree);
    $("#img3").html("<img src=" + "assets/images/white.jpg" + " value=" + gemThree + ">");

    var gemFour = Math.floor(Math.random() * 12) + 1;
    console.log("Gem 4: " + gemFour);
    $("#img4").html("<img src=" + "assets/images/green.jpg" + " value=" + gemFour + ">");
